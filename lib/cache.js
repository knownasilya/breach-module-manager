...
var read = Promise.denodeify(fs.readFile),
  readUTF8 = function (path) { return read(path, { encoding: 'utf8' }); },
  write = Promise.denodeify(fs.writeFile),
  jsonParse = function (data) { return Promise.denodeify(JSON.parse)(data); }
 ...
 */
var refreshFromNPM = function (since) {
  since = since || new Date('2014-02-14').getTime();
  return new Promise(function (resolve, reject) {
    request.get({ json: true, url: 'https://registry.npmjs.org/-/aill/since?stale=update_after&startkey=' + since } , function(err, httpMessage, body) {
...
var filterNpmCache = function (obj) {
 ...
 */
var updateMetadata = function (mixed) {
...
var writeCache = function () {
  if (cache.dirty) {
    ...
    cache.dirty = false;
    return write(localCache, JSON.stringify(cache.packages));
  }
 ...
 */
var updateFromNPM = function (obj) {
...
var filterByQuery = function (pkg) {
